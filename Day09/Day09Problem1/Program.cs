namespace Day09Problem1
{
    ...
    internal class Program
    {
        ...
        {
            //Console.Out.WriteLine($"entering with {sequence.Elements.Last()} and {sequence.Derivative.Elements.Last()}");
            if (sequence.Derivative.Elements.Last() == 0)
            {
                return sequence.Elements.Last();
            }
            else
            {
                return sequence.Elements.Last() + PredictNext(sequence.Derivative);
            }
        }
